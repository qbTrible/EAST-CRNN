...
def train(train_img_path, pths_path, batch_size, lr, decay, num_workers, epoch_iter, interval, pretained):
    ...
    for epoch in range(epoch_iter):
        ...
        for i, (img, gt_map) in enumerate(train_loader):
            ...
            inside_score_loss, side_vertex_code_loss, side_vertex_coord_loss = criterion(gt_map, east_detect)
            ...
            if i % 10 == 0:
                ...
                print("inside_score_loss: %f | side_vertex_code_loss: %f | side_vertex_coord_loss: %f" % (
