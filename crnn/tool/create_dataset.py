...
if __name__ == '__main__':
    ...
    #                     default=r"D:\Data\dataset_for_crnn\lmdb_data")
    # parser.add_argument('--folder', type=str, help='path to folder which contains the images',
    #                     default=r"D:\Data\dataset_for_crnn\train_img")
    # parser.add_argument('--file', type=str, help='path to file which contains the image path and label')
    # args = parser.parse_args()
    out_dir = r"D:\Data\dataset_for_crnn\test_lmdb_data"
    img_folder = r"D:\Data\dataset_for_crnn\test_img"

    image_path_list, label_list = read_data_from_folder(img_folder)
    createDataset(out_dir, image_path_list, label_list)
